...
public class Archer extends Personnage implements Combattant {
     ...
     * <p>Permet d’initialiser toutes les caractéristiques de l’archer.</p>
     *
     ...
     */
    public Archer(String n, int pV, int dA, int pPar, int paAtt, int paPar,
                  int dMax, Point2D p, int nbFleches) {
     ...
     * <pre>Archer robin 75 20 5 75 30 5 15 5 20</pre>
     *
     * @param ligne ligne de texte contenant les informations de l’archer
     */
    ...
    /** @return le nombre de flèches restantes */
     ...
     * <pre>
     * Archer nom ptVie degAtt ptPar pageAtt pagePar distAttMax nbFleches posX posY
     * </pre>
     *
     * @return chaîne prête à être enregistrée dans un fichier texte
     */
